...
const pageTabs = [
  ...
  { label: 'Contact', href: '/dashboard/contact-page' },
]
  ...
  return (
    <div className="sticky top-0 z-30 bg-[#111111]/80 backdrop-blur-xl border-b border-white/[0.06]">
      ...
      <div className="flex items-center gap-2 px-6 pb-3 overflow-x-auto scrollbar-none">
        {pageTabs.map((tab) => {
          const mainSubPaths = ['/dashboard/hero', '/dashboard/services', '/dashboard/our-work', '/dashboard/technology', '/dashboard/testimonials', '/dashboard/contact', '/dashboard/blogs']
